...
urlpatterns = [
    ...
    path('follow/<int:to_user_id>', views.UserFollowView.as_view(), name='user_follow'),
    path('unfollow/<int:to_user_id>', views.UserUnfollowView.as_view(), name='user_unfollow'),
